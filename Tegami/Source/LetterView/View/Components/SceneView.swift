...
final class SceneView: UIView {
    ...
    private lazy var backgroundImage: UIImageView = {
        self.makeImageView(named: "fundoB-tree", contentMode: .scaleAspectFill)
    }()

    private(set) lazy var cloudImage: UIImageView = {
        self.makeImageView(named: "aCloud", contentMode: .scaleAspectFit)
    }()

    private lazy var grassImage: UIImageView = {
        self.makeImageView(named: "aGrass", contentMode: .scaleAspectFit)
    }()

    private lazy var treeImage: UIImageView = {
        self.makeImageView(named: "Arvore5", contentMode: .scaleAspectFit)
    }()
